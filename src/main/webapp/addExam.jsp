    ...
    <div class="container" style="margin-top: 10px">
        ...
        <div class="row clearfix" style="margin: 10px 0 0 0">
		    ...
		    <select class="form-control" style="margin: 15px 0 0 0 " id="showCourse2List" onchange="selectOnchang2(this)"> 
				...
				<button class="btn btn-warning btn-lg btn-block" style="width:300px;height:45px;margin:15px 0 15px 0;margin-left:auto;margin-right:auto;" id="sureAlter">确认上传</button>
         	</div>
        </div>
    </div>
</body>
		...
		if(cid==""){
			...
			if(confirm("确认提交？")){
				$.ajax({
					url:"./admin/addExam",
					type:"POST",
					data:{"title":FirTitle,"option_a":FirA,"option_b":FirB,"option_c":FirC,"option_d":FirD,"option_r":FirR,"cid":cid,"ccid":ccid},
					datatype:"json",
					success:function(data){
						data=JSON.parse(data);
						if(data.code==1){
				...
				$.ajax({
					url:"./admin/addExam",
					type:"POST",
					data:{"title":SecTitle,"option_a":SecA,"option_b":SecB,"option_c":SecC,"option_d":SecD,"option_r":SecR,"cid":cid,"ccid":ccid},
					datatype:"json",
					success:function(data){
						data=JSON.parse(data);
						if(data.code==1){
				...
				$.ajax({
					url:"./admin/addExam",
					type:"POST",
					data:{"title":ThiTitle,"option_a":ThiA,"option_b":ThiB,"option_c":ThiC,"option_d":ThiD,"option_r":ThiR,"cid":cid,"ccid":ccid},
					datatype:"json",
					success:function(data){
						data=JSON.parse(data);
						if(data.code==1){
				...
				$.ajax({
					url:"./admin/addExam",
					type:"POST",
					data:{"title":ForTitle,"option_a":ForA,"option_b":ForB,"option_c":ForC,"option_d":ForD,"option_r":ForR,"cid":cid,"ccid":ccid},
					datatype:"json",
					success:function(data){
						data=JSON.parse(data);
						if(data.code==1){
				...
				$.ajax({
					url:"./admin/addExam",
					type:"POST",
					data:{"title":FifTitle,"option_a":FifA,"option_b":FifB,"option_c":FifC,"option_d":FifD,"option_r":FifR,"cid":cid,"ccid":ccid},
					datatype:"json",
					success:function(data){
						data=JSON.parse(data);
						if(data.code==1){
